...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      {/*-----left-----*/}
      <img src={assets.logo_big} alt="" srcset="" className='w-[min(30vw,250px)]' />
      {/*----right------*/}
      ...
      <h2 className='font-medium text-2xl flex justify-between items-center'> 
        ...
        (<input onChange={(e)=>setfullName(e.target.value)} value={fullName}className='p-2 border border-gray-500 rounded-md focus:outline-none ' placeholder='Full Name' required/>
      )}
      {!isDataSubmitted && (
        <>
...

      {
        ...
        <div className='flex items-center gap-2 text-sm text-gray-500'>
          <input type="checkbox" />
          <p>Agree to the term of use & privacy police.</p>
